...
save_best = ModelCheckpoint(filepath='D:/AI in medicine/final_project_mobilenet/inceptionv3/checkpoint-{val_acc:.4f}.h5',monitor='val_acc',mode='auto',save_best_only=True)
