...
base_skin_dir = "D:/AI in medicine/final_project_mobilenet/skin"
...
np.save("a_test.npy", X_test)
np.save("a_test_labels.npy", y_test)


X_train, X_val, y_train, y_val = train_test_split(X_train_orig, y_train_orig, test_size=0.17, random_state=1)

np.save("a_val.npy", X_val)
np.save("a_val_labels.npy", y_val)

np.save("a_train.npy", X_train)
np.save("a_train_labels.npy", y_train)
